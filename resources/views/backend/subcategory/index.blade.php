...
<div class="card">
                  <div class="card-body">
                    ...
                    <a href="{{route('subcategories.create')}}" class="btn btn-primary" style="float: right;">Add SubCategory</a>
                        ...
                        <tbody>
                            @foreach($subcategories as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('subcategory.edit',$row->id)}}" class="btn btn-primary">Edite</a>
