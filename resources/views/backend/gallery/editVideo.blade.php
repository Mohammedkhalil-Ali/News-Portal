            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" action="{{route('galleryVideo.update',$videos->id)}}">
                      @csrf
                  
                      <div class="form-group col-md-6">
                        <label for="exampleInputName1">Title</label>
                        <input type="text" class="form-control" id="title" placeholder="Title" name="title" value="{{$videos->title}}">
                      </div>
                    ...
                    <div class="form-group col-md-6">
                      ...
                      <div class="form-group">
                            ...
                            <input class="form-control" type="text" id="videolink" name="video_link" value="{{$videos->video_link}}">
                        </div>
