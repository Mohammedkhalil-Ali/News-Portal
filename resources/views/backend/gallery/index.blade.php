...
<div class="card">
                  <div class="card-body">
                    ...
                    <a href="{{route('gallery.create')}}" class="btn btn-primary" style="float: right;">Add row</a>
                        ...
                        <tbody>
                            @foreach($gallery as $row)
                                <tr>
                                    ...
                                    <td>{{$row->type}}</td>
                                    <td>
                                        <a href="{{route('gallery.edit',$row->id)}}" class="btn btn-primary">Edite</a>
                                        <a href="{{route('gallery.delete',$row->id)}}" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody> 
