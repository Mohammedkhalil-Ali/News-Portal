...
<div class="content-wrapper">
            ...
            @csrf
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control form-control-lg" placeholder="District English" name="district_en">
                      @error('district_en')
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" placeholder="District Hindi" name="district_hin">
                      @error('district_hin')
                        <span class="text-danger">{{$message}}</span>
                      @enderror
                    </div>
