            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="POST" enctype="multipart/form-data" action="{{route('Ads.update',$ads->id)}}">
                      @csrf
                  
                      <div class="form-group col-md-6">
                        <label for="exampleInputName1">Link</label>
                        <input type="text" class="form-control" id="title" placeholder="Title" name="link_ads" value="{{$ads->link_ads}}">
                      </div>

                    <div class="form-group col-md-6">
                        <label for="type">Type</label>
                        <select class="form-control" id="type" name="shewakay">
                        <option value="1" <?php if($ads->shewakay==1) echo "selected"; ?>>Vertical Image</option>
                        <option value="0" <?php if($ads->shewakay==0) echo "selected"; ?>>Horizantle Image</option>
                        </select>
                      </div>
