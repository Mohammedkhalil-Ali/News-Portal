...
<div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Notices Page</h4>
                    <a href="{{ route('Setting.Notices.create') }}" class="btn btn-primary" style="float: right;">Add Notice</a>
                        ...
                        <tbody>
                            @foreach($notices as $row)
                                <tr>
                                    ...
                                    <td>{{$row->status}}</td>
                                    <td>
                                        <a href="{{route('Setting.Notices.delete',$row->id)}}" class="btn btn-danger">Delete</a>
                                        <a href="{{route('Setting.Notices.edit',$row->id)}}" class="btn btn-primary">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody> 
