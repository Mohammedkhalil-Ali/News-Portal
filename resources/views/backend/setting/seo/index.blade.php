...
<div class="card">
                  <div class="card-body">
                    ...
                    <a href="{{route('Setting.Seo.create')}}" class="btn btn-primary" style="float: right;">Add Category</a>
                    <div class="table-responsive">
                      <table class="table table-striped">
                        ...
                        <tbody>
                            @foreach($seos as $row)
                                <tr>
                                    <td>{{$row->meta_author}}</td>
                                    <td>{{$row->meta_title}}</td>
                                    <td>{{$row->meta_keyword}}</td>
                                    <td>{{$row->meta_description}}</td>
                                    <td>{{$row->google_analytics}}</td>
                                    <td>{{$row->google_verification}}</td>
                                    <td>{{$row->alexa_analytics}}</td>
                                    <td>
                                        <a href="{{route('Setting.Seo.edit',$row->id)}}" class="btn btn-primary">Edit</a>
                                        <a href="{{route('Setting.Seo.delete',$row->id)}}" class="btn btn-danger">Delete</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody> 
