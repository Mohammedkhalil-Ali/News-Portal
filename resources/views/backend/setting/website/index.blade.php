...
<div class="card">
                  <div class="card-body">
                    ...
                    <a href="{{route('Setting.Website.create')}}" class="btn btn-primary" style="float: right;">Add Website</a>
                        ...
                        <tbody>
                            @foreach($websites as $row)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('Setting.Website.delete',$row->id)}}" class="btn btn-danger">Delete</a>
                                        <a href="{{route('Setting.Website.edit',$row->id)}}" class="btn btn-primary">Edit</a>
                                    </td>
                                </tr>
                            @endforeach
                        </tbody> 
