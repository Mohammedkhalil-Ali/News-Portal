...
<div class="content-wrapper">
            ...
            @csrf
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="exampleInputName1" placeholder="English" name="subdistrictEn">
                      </div>
                      <div class="form-group">
                        <label for="exampleInputEmail3">Hindi</label>
                        <input type="text" class="form-control" id="exampleInputEmail3" placeholder="Hindi" name="subdistrictHindi">
                      </div>
                      <div class="form-group">
